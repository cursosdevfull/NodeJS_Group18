...
class User {
    ...
    constructor(database: Database, name: string, lastname: string, email: string, userId?: number) {
        this.name = name
...
const user = new User(database, "Magaly", "Cárdenas", "magaly.cardenas@email.com")
user.insert()
